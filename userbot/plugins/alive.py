...
from userbot.utils import SinX_cmd, edit_or_reply, sudo_cmd

ALIVE_PIC = os.environ.get("ALIVE_PIC", None)
if ALIVE_PIC is None:
    PM_iMG = "https://telegra.ph/file/73c792ce99170bab53fb1.jpg"
else:
    PM_iMG = ALIVE_PIC
...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/73c792ce99170bab53fb1.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/73c792ce99170bab53fb1.jpg"
else:
    CAT_IMG = CAT_IMGE
...
catversion = "3.0"
ALIVE_MSG = Config.ALIVE_MSG or "✮ SINX IS RUNNING SUCCESFULLY ✮"
...
@borg.on(SinX_cmd(outgoing=True, pattern="salive"))
@borg.on(sudo_cmd(pattern=r"salive", allow_sudo=True))
async def amireallyalive(salive):
    """ For .alive command, check if the bot is running.  """
    if ALIVE_PHOTTO:
        pm_caption = "**𝙎𝙞𝙣𝙓 𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝙄𝙨 𝙊𝙣𝙡𝙞𝙣𝙚**\n"
        pm_caption += f"**𝕄𝕪 𝔹𝕠𝕤𝕤**            : {DEFAULTUSER}\n"
        pm_caption += "𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽        : 1.17.5\n"
        pm_caption += "𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽          : 3.9.0\n"
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/sinx_updates)\n"
        )
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/sinx_support)\n"
        )
        pm_caption += "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://t.me/The_Sinners_Empire)\n"
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ вℓα¢к ℓιgнтηιηg ](https://t.me/sinx_updates)\n"
        pm_caption += "[┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/The_Sinners_Empire)",
        ...
        return
    req = requests.get("https://telegra.ph/file/73c792ce99170bab53fb1.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            salive.chat_id,
            "**𝙎𝙞𝙣𝙓 𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝙄𝙨 𝙊𝙣𝙡𝙞𝙣𝙚**\n"
            f"**𝕄𝕪 𝔹𝕠𝕤𝕤**            : {DEFAULTUSER}\n"
            "𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽        : 1.17.5\n"
            "𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽          : 3.9.0\n"
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/sinx_updates)\n"
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/sinx_support)\n"
            "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://t.me/The_Sinners_Empire)\n"
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ 𝙎𝙞𝙣𝙓 𝙐𝙨𝙚𝙧𝙗𝙤𝙩 ](https://t.me/sinx_updates)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/The_Sinners_Empire)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥𝙎𝙞𝙣𝙓 𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝙄𝙨 𝙊𝙣𝙡𝙞𝙣𝙚🔥🔥**__\n\n"

pm_caption += (
    f"               __↼🄼🄰🅂🅃🄴🅁⇀__\n**『[{DEFAULTUSER}](tg://user?id={lucifer_sinx})』**\n\n"
)

pm_caption += "🛡️TELETHON🛡️ : `1.15.0` \n"

pm_caption += f"😈𝙎𝙞𝙣𝙓 𝙐𝙨𝙚𝙧𝙗𝙤𝙩😈       : __**{hellversion}**__\n"

pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/sinx_updates)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/lucifer_sinx)\n\n"

pm_caption += "    [✨REPO✨](http://github.com/TeamSinx/SinX-Userbot) 🔹 [📜License📜](http://github.com/TeamSinx/SinX-Userbot/blob/master/LICENSE)"


@borg.on(SinX_cmd(outgoing=True, pattern="halive$"))
...
@borg.on(SinX_cmd(outgoing=True, pattern="calive$"))
...
async def amireallyalive(calive):
    ...
    if PM_IMG:
        ...
        pm_caption += f"**{EMOJI} SinX Userbot Version :** `{catversion}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} SinX Userbot Version :** `{catversion}`\n"
...
CMD_HELP.update(
    {
        ...
        \n\n**Syntax : **`.halive `\
        \n**Function : **__ .hell Userbot's Alive.__\
        \n\n**Syntax : **`.alive `\
        \n**Function : **__ .SinX Userbot's Alive.__\
        \n\n**Syntax : **`.awake `\
